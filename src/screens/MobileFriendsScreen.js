...
export default function MobileFriendsScreen({ onLogout, user, onCreateServer }) {
          ...
          <ScrollView style={styles.dmList} showsVerticalScrollIndicator={false}>
            {DIRECT_MESSAGES.map((dm) => (
              <TouchableOpacity 
                key={dm.id} 
                style={styles.dmItem}
                onPress={() => setShowDMSidebar(false)}
              >
